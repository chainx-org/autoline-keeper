...
interface IJob {
    function getNextJob() external view returns (bool canExec, address target, bytes memory execPayload);
}
...
contract AutoLineJob is IJob {
    ...
    constructor(address _ilkRegistry, address _autoline, uint256 _thi, uint256 _tlo) {
    ...
    function getNextJob() external view override returns (bool, address, bytes memory) {
